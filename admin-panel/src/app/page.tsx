  ...
  return (
    <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 space-y-8">
      ...
      <div className="bg-gray-950 border-2 border-green-500 rounded p-6 mt-8" style={{ boxShadow: '0 0 20px rgba(0,255,100,0.3), inset 0 0 10px rgba(0,255,100,0.1)' }}>
        ...
        <p className="text-green-300 text-sm font-mono" style={{ textShadow: '0 0 10px rgba(0,255,100,0.5)' }}>$ DuckDuckGo scraper is running in real-time monitoring mode. Data refreshes automatically every 30 seconds. Status: <span className="text-lime-400 font-bold">ACTIVE</span></p>
      </div>
    </div>
  );
}
